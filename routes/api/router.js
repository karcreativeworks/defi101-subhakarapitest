 ...
 * /walletBalance:
 *   get:
 *     summary: Fetch wallet balance of a erc20 token live from chain
 *     description: Fetch wallet balance of a erc20 token live from chain
 *     tags: [walletBalance]
 *     parameters:
 *       - in: query
 *         name: chainId
 ...
 *         description: Fetch wallet balance of a erc20 token live from chain
 */
router.get("/walletBalance", balanceController.fetchWalletBalance);
